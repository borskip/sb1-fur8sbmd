/*
  # Fix watched movies table migration
  
  1. Changes
    - Drop existing table if exists
    - Create watched_movies table with proper constraints
    - Add RLS policies for test users
  
  2. Security
    - Enable RLS
    - Add policies for test users to manage their watched movies
*/
