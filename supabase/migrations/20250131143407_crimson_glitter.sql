...
DROP POLICY IF EXISTS "Users can read all personal watchlists" ON personal_watchlist;
DROP POLICY IF EXISTS "Users can manage their personal watchlist" ON personal_watchlist;
